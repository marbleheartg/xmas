    ...
    <main>
      <div className={clsx("fixed top-35 inset-x-1/12 px-1 pt-3.5 pb-3 z-30", "flex flex-col items-center", "rounded-4xl", "bg-white/10 glass")}>
        ...
        <div className="flex gap-3 py-1.5">
          <button onClick={() => sdk.actions.viewCast({ hash: "0x03981dd309aedddd5a8e38b626d8ed2f2fb64c86" })}>
          ...
          <button className="pt-[6px]" onClick={() => sdk.actions.viewCast({ hash: "0x03981dd309aedddd5a8e38b626d8ed2f2fb64c86" })}>
